...
If you need to customize the build (e.g., set maintainer, description, categories, etc.), refer to the available options in the [Electron Forge deb maker config documentation](https://github.com/electron/forge/blob/9f35bdea87fe0df5b2566b74ff909f2f037ef556/packages/maker/deb/src/Config.ts#L211).
